function [A_hat, loss, loss_true, MSE, grad,kk]=ar1_group_lasso(X,X0,init,lambda,epsilon,iters,K)
%estimate group sparse A generated by X_t ~ Poisson(exp(nu+A*min(X_{t-1},K))
%using MLE with an group lasso regularization penalty.  
%groups correspond to columns of matrix
...
A_hat=zeros(init); %Initialize at true A for hopefully faster convergence

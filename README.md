This repository contains code which for estimating high-dimensional networks generated by saturated log-linear point process models.  We consider a variant of an AR(1) model: 
